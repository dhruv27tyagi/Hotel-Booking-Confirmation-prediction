...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            logger.info("Starting our Data Processing stage")
            ...
            logger.error(f"Error during preprocess stage {e}")
            raise CustomException("Error while preprocessing data", e)
        

    def balance_data(self,df):
        try:
            logger.info("We are balanciong our data - Handling imbalanced data")
